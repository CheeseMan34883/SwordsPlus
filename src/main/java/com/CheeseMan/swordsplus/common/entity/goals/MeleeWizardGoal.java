...
public class MeleeWizardGoal extends Goal {
    ...
    public static final int rangeNoAttacks = 20;
    ...
    public boolean canUse() {
        ...
        if (i - this.lastCanUseCheck < 20L) {
            ...
            if (livingentity == null) {
                ...
                return false;
            } else if (livingentity.blockPosition().distSqr(this.wizard.blockPosition()) > Math.pow(rangeNoAttacks, 2)) {
                return false;
            } else {
                if (canPenalize) {
