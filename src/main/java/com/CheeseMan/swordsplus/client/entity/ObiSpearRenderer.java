...
public class ObiSpearRenderer extends EntityRenderer<ObiSpearEntity> {
	...
	private final ObiSpearModel model = new ObiSpearModel();
	...
	@Override
	public void render(ObiSpearEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
		...
		itemRenderer.renderStatic(p_225623_1_.getPickupItem(), ItemCameraTransforms.TransformType.GROUND, p_225623_6_, OverlayTexture.NO_OVERLAY, p_225623_4_, p_225623_5_);
