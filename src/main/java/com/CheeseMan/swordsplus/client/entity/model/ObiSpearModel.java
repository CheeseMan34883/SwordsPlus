...
public class ObiSpearModel<T extends ObiSpearEntity> extends EntityModel<T> {
	...
	@Override
	public void setupAnim(ObiSpearEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
