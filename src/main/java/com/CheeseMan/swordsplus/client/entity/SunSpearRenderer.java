...
public class SunSpearRenderer extends EntityRenderer<SunSpearEntity> {
	
	public static final ResourceLocation SUN_SPEAR_LOCATION = new ResourceLocation("textures/entity/sun_spear/sun_spear.png");
	private final SunSpearModel model = new SunSpearModel();

	public SunSpearRenderer(EntityRendererManager manager) {
		super(manager);
	
	}
	
	public void render(SunSpearEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
	...
	@Override
	public ResourceLocation getTextureLocation(SunSpearEntity p_110775_1_) {
		return SUN_SPEAR_LOCATION;
	}
