...
public class SpawnEggItemInit extends SpawnEggItem {
	protected static final List<SpawnEggItemInit> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public SpawnEggItemInit(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
