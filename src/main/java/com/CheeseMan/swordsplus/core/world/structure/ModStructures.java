package com.CheeseMan.swordsplus.core.world.structure;

import java.util.HashMap;
import java.util.Map;

import com.CheeseMan.swordsplus.SwordsPlus;
import com.CheeseMan.swordsplus.core.world.structure.structures.WizardTowerStructure;
...
public class ModStructures {
	public static final DeferredRegister<Structure<?>> STRUCTURES = DeferredRegister
			.create(ForgeRegistries.STRUCTURE_FEATURES, SwordsPlus.MOD_ID);

	public static final RegistryObject<Structure<NoFeatureConfig>> WIZARD_TOWER = STRUCTURES.register("wizard_tower",
			WizardTowerStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(WIZARD_TOWER.get(),
                new StructureSeparationSettings(400,180, 1234567890),
                true);
    }
